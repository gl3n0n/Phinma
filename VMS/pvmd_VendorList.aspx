...
<asp:GridView ID="GridView1" runat="server" DataSourceID="dsVendorAuthenticated" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Submitted to VM Assessment" InsertVisible="False" SortExpression="DateSubmittedToDnb" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="10px">
            <HeaderStyle HorizontalAlign="Center" Width="90px" />
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Endorsed to VP" InsertVisible="False" SortExpression="approvedbyVMRecoDate" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="10px">
            <HeaderStyle HorizontalAlign="Center" Width="90px" />
            <ItemTemplate>
