...
public partial class vmofficer_VendorForNotification_List_Sent : System.Web.UI.Page
{
                    ...
                    using (cmd = new SqlCommand(query, conn))
                    {
                        ...
                        if (oReader.HasRows)
                        {
                            ...
                            if (Arr[1].ToString() == "6")
                            {
                                ...
                                Response.Write("<script type='text/javascript'>window.open('exportVendorInformation.aspx', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');;</script>");
                            }
                        }
                    }
                }
                ...
                if (oReader.HasRows)
                {
                    while (oReader.Read())
                    {
                       ...
                       // query = "INSERT INTO tblVendorCategoriesAndSubcategories (VendorId, CategoryId, IncludesAllSubCategories, MainCategoryId) VALUES ((select MAX(VendorId) from tblVendors), @CategoryId, @IncludesAllSubCategories, @MainCategoryId)";
                        ...
                        query = "INSERT INTO tblVendorCategoriesAndSubcategories (VendorId, CategoryId, IncludesAllSubCategories) VALUES ((select MAX(VendorId) from tblVendors), 'CAT000', 1)";
