...
{	
	public class Constant
	{
        ...
        public static int VENDOR_STATUS_TOPVMDHEAD                  = 4;    // VP Head/\FAA Logistics recieves endorsement from VM Head
        public static int VENDOR_STATUS_TOCFO                       = 5;    // CFO/\FAA Finance recieves endorsement from VP Head
        ...
        public static int VENDOR_STATUS_DNBCLARIFY                  = 9;    // VM Assessment Clarify to Vendor
