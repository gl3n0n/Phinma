...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--<asp:Label runat="server" ID="txtNote" ForeColor="#FF0000" Style="font-weight: bold"></asp:Label>
      <asp:TextBox ID="txtUserName" runat="server" CausesValidation="True" value="ENTER YOUR USERNAME" onclick="if($(this).val()=='ENTER YOUR USERNAME'){ $(this).select(); } " onblur="if($(this).val()==''){ $(this).val('ENTER YOUR USERNAME'); }" style="text-align:center; padding:0px;" ></asp:TextBox>--%>
    <asp:Label runat="server" ID="txtNote" ForeColor="#FF0000" Style="font-weight: bold"></asp:Label>
      ...
      <%--<asp:TextBox runat="server" ID="txtPassword" TextMode="Password" CausesValidation="True" value="" onclick="$(this).select();" onblur="if($(this).val()==''){ $(this).val(''); }"  style="text-align:center; padding:0px;"  ></asp:TextBox>--%>
...
<%--<asp:LinkButton ID="loginBt" runat="server" CssClass="bt1"   OnClick="btnLogin_Click" style="float:none; "><span>LOGIN</span></asp:LinkButton>--%>
          <input id="btnLogin" name="btnLogin" class="bt1" type="image" src="images/bt1_submit.png" runat="server"  onserverclick="btnForgotPwd_Click"  style="float:none; "  />
          
      <div class="clearfix"></div>
      </div><br />
          <div style="float:none; margin:auto; font-size:18px;"><a href="login.aspx" style="font-size:14px">Login here</a></div>
      </div>
