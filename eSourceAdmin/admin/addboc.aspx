<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addboc.aspx.cs" Inherits="admin_addboc" %>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td id="Td1">
                                                            <h1>
                                                                <br />
                                                                Add New Bid Opening Committee</h1>
                                                        </td>
                                                    </tr>
                                                    <tr align="right">
                                                    ...
                                                    <tr>
                                                        <td id="content0">
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="actions">
                                                                <tr>
                                                                    <td>
                                                                        <asp:LinkButton ID="lnkSave" runat="server" Text="Save" OnClientClick="return confirm('Add New BOC?');" OnClick="lnkSave_Click" ></asp:LinkButton>
