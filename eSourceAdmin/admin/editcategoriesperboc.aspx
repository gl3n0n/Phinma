<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editcategoriesperboc.aspx.cs" Inherits="admin_editcategoriesperboc" %>
                            ...
                            <tr>
                                ...
                                <td id="content">
                                                  ...
                                                  OnRowCommand="gvBOCProcurement_RowCommand">
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="&nbsp;">
                                                            ...
                                                            <ItemTemplate>
                                                                &nbsp;<asp:LinkButton ID="lnkEditBOCProcurement" runat="server" CommandName="EditBOCProcurement" CommandArgument='<%# Eval("BOCId") %>'>Edit</asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="actions">
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="lnkSave" runat="server" Text="Save" OnClientClick="return confirm('Overwrite Previous Data?');"></asp:LinkButton>
                                                <a href="categoriesperboc.aspx">Cancel</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
