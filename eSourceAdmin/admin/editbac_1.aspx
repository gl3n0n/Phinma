                                                        ...
                                                        <td id="content0">
                                                            ...
                                                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="300px" id="itemDetails1">
                                                                ...
                                                                <tr class="evenCells">
                                                                    ...
                                                                    <td style="height: 30px">
                                                                        <asp:TextBox ID="ApprovingLimitOnLowestPrice" runat="server" Width="35%" MaxLength="70" />
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" EnableClientScript="False"
                                                                            ErrorMessage="* Required" ControlToValidate="ApprovingLimitOnLowestPrice"></asp:RequiredFieldValidator></td>
                                                                </tr>
                                                                <tr class="value">
                                                                    <td style="width: 19%; height: 30px;">
                                                                        Approving 
                                                                    ...
                                                                    <td style="height: 30px">
                                                                        <asp:TextBox ID="ApprovingLimitOnNonLowestPrice" runat="server" Width="35%" MaxLength="70" />
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" EnableClientScript="False"
                                                                            ErrorMessage="* Required" ControlToValidate="ApprovingLimitOnNonLowestPrice"></asp:RequiredFieldValidator></td>
                                                                </tr>
                                                                <tr class="evenCells">
                                                                    <td style="width: 120px;padding-top: 7px" >
                                                                       OIC</td>
                                                                    <td>
                                                                        <asp:RadioButtonList ID="OIC" runat="server" 
