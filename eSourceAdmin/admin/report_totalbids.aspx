<%@ Page Language="C#" AutoEventWireup="true" CodeFile="report_totalbids.aspx.cs" Inherits="web_admin_report_totalbids" %>

<%@ Register Src="../usercontrol/reports/totalbids.ascx" TagName="totalbids" TagPrefix="uc2" %>
                            ...
                            <tr>
                                ...
                                <td id="content">
                                    <div align="left">
                                        ...
                                        <div>
                                            <br />                                            
                                            <uc2:totalbids ID="TotalBids1" runat="server" />
                                        </div>
                                    </div>
                                </td>
                            </tr>
