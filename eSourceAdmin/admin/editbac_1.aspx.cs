...
public partial class admin_editbac : System.Web.UI.Page
{
    ...
    private bool UpdateBOCDetails()
    {
        ...
        try
        {
            ...
            sqlParams[5] = new SqlParameter("@ApprovingLimitOnNonLowestPrice", SqlDbType.Float);
            sqlParams[6] = new SqlParameter("@OIC", SqlDbType.Int);
 
            sqlParams[0].Value = Int32.Parse(ViewState["sUserID"].ToString().Trim());
            sqlParams[1].Value = tbFirstName.Text.Trim();
            sqlParams[2].Value = tbLastName.Text.Trim();
            sqlParams[3].Value = tbMidInitial.Text.Trim();
            sqlParams[4].Value = ApprovingLimitOnLowestPrice.Text.Trim();
            sqlParams[5].Value = ApprovingLimitOnNonLowestPrice.Text.Trim();
            sqlParams[6].Value = Convert.ToInt32(OIC.Text.Trim());
