<%@ Page Language="C#" AutoEventWireup="true" CodeFile="report_vendorlist.aspx.cs" Inherits="admin_report_vendorlist" %>

<%@ Register Src="../usercontrol/reports/vendorlist.ascx" TagName="vendorlist" TagPrefix="uc2" %>
                            ...
                            <tr>
                                ...
                                <td id="content">
                                    <div align="left">
                                        ...
                                        <div>
                                            <br />                                            
                                            <uc2:vendorlist ID="VendorList1" runat="server" />
                                        </div>
                                    </div>
                                </td>
                            </tr>
