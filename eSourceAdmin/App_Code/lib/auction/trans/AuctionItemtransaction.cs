...
/// <summary>
/// Summary description for AuctionItemtransaction
/// </summary>
namespace EBid.lib.auction.trans
{
    public class AuctionItemtransaction
    {
        private static string connstring = HttpContext.Current.Session["ConnectionString"].ToString();

        public DataTable QuerySubmittedAuctions(string orderby)
        {
        ...
        public AuctionItem QueryAuctionItemInfo(string AuctionRefNo)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@auctionRefNo", SqlDbType.Int);
        ...
        public string GetAuctionTypeById(string vAuctionType)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
        ...
        public string getBidCurrency(string vBidCurrency)
        {
            switch (vBidCurrency)
            {
                case "0":
        ...
        public void UpdateAuctionStatus(string vAuctionRefNo, string vUser, int vStatus)
        {
            if ((vUser != null) && (vUser != ""))
            {
        ...
        public DataTable QueryConfirmedVendors(string orderby, string vAuctionRefNo)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@auctionRefNo", SqlDbType.Int);
            sqlParams[0].Value = Int32.Parse(vAuctionRefNo.Trim());
        ...
        public DataTable QueryAllAwardedAuctionItems(string auctionEvent)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
        ...
        public DataTable QueryAwardedAuctionItems(string company, string category, string month, string day, string year)
        {
        ...
        public string GetAuctionRefNobyBidRefNo(string BidRefNo)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
