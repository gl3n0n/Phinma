<%@ Control Language="C#" AutoEventWireup="true" CodeFile="auctionfooter.ascx.cs" Inherits="web_user_control_auctionfooter" %>
...
<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="http://www.globeplatinum.com.ph/" Target="_blank">Globe Platinum</asp:HyperLink>
 ...
 | <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="http://www.myglobe.com.ph/" Target="_blank">myGlobe</asp:HyperLink> 
