...
namespace EBid.lib.bid.trans
{
	...
	{
        public string GetCompanyName(string connstring, string vCompanyId) 
		{
        ...
        public CompanyDetails QueryCompanyDetails(string connstring, string vendorID)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
        ...
        public void UpdateCompanyDetails(string connstring, string vendorID, CompanyDetails companyInfo)
        {
        ...
        public string GetClassificationName(string connstring, string classification)
        {
            if (classification == "0")
                classification = "1";
        ...
        public string GetOrganizationType(string connstring, string orgType)
        {
            if (orgType == "0")
                orgType = "1";
        ...
        public DataTable QueryPresentServices(string connstring, string vendorId)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@vendorId", SqlDbType.Int);
            sqlParams[0].Value = Int32.Parse(vendorId);
        ...
        public DataTable QueryAllGlobePlans(string connstring)
        {
            return SqlHelper.ExecuteDataset(connstring, CommandType.Text, "s3p_EBid_QueryAllGlobePlans").Tables[0];
        }

        public DataTable QueryVendorReferences(string connstring, string vendorId, int vendRefType)
        {
        ...
        public string GetReferenceTypeName(string connstring, string refTypeID)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
        ...
        public string GetReferenceTypeExtra(string connstring, string refTypeID)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@refId", SqlDbType.Int);
            sqlParams[0].Value = Int32.Parse(refTypeID);
        ...
        public DataTable QueryVendorEquipments(string connstring, string vendorId)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@vendorId", SqlDbType.Int);
            sqlParams[0].Value = Int32.Parse(vendorId);
        ...
        public DataTable QueryVendorRelatives(string connstring, string vendorId)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@vendorId", SqlDbType.Int);
            sqlParams[0].Value = Int32.Parse(vendorId);
        ...
        public DataTable QueryVendorProdBrands(string connstring, string vendorId, bool isSelected)
        {
            DataTable dt = null;
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@vendorId", SqlDbType.Int);
        ...
        public DataTable QueryVendorItemsCarried(string connstring, string vendorId, bool isSelected)
        {
            DataTable dt = null;
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@vendorId", SqlDbType.Int);
        ...
        public DataTable QueryVendorServices(string connstring, string vendorId, bool isSelected)
        {
            DataTable dt = null;
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@vendorId", SqlDbType.Int);
        ...
        public DataTable QueryVendorLocations(string connstring, string vendorId, bool isSelected)
        {
            DataTable dt = null;
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@vendorId", SqlDbType.Int);
        ...
        public DataTable QueryVendorSearch(string connstring, string searchstring)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
        ...
        public void UpdatePresentServices(string connstring, string vendorID, string planID, string presentSvcID, 
        ...
        public void UpdateEquipments(string connstring, string vendorID, string eqpmntID, string eqpmntType,
        ...
        public void UpdateRelatives(string connstring, string vendorID, string relativeID, string relative,
        ...
        public void UpdateReference1(string connstring, string vendorID, string referenceNo, string companyName, string avemonthly, bool isNew)
        {
            if (isNew)
            {
                SqlParameter[] sqlParams = new SqlParameter[4];
        ...
        public void UpdateReference2(string connstring, string vendorID, string referenceNo, string companyName, string creditline, bool isNew)
        {
            if (isNew)
            {
                SqlParameter[] sqlParams = new SqlParameter[4];
        ...
        public void UpdateReference3(string connstring, string vendorID, string referenceNo, string companyName, string kindofbus, bool isNew)
        {
            if (isNew)
            {
                SqlParameter[] sqlParams = new SqlParameter[4];
        ...
        public void UpdateReference4(string connstring, string vendorID, string referenceNo, string companyName, string legalcouns, bool isNew)
        {
            if (isNew)
            {
                SqlParameter[] sqlParams = new SqlParameter[4];
        ...
        public void DeletePresentSvc(string connstring, string presentSvcId)
        {
            if (presentSvcId != "")
            {
                SqlParameter[] sqlParams = new SqlParameter[1];
        ...
        public void DeleteReference(string connstring, string referenceNo)
        {
            if (referenceNo != "")
            {
                SqlParameter[] sqlParams = new SqlParameter[1];
        ...
        public void DeleteEquipment(string connstring, string equipmentID)
        {
            if (equipmentID!="")
            {
                SqlParameter[] sqlParams = new SqlParameter[1];
        ...
        public void DeleteRelative(string connstring, string relativeId)
        {
            if (relativeId != "")
            {
                SqlParameter[] sqlParams = new SqlParameter[1];
        ...
        public DataTable GetCompanies(string connstring)
        {
        ...
        public DataTable QueryAllPCABClass(string connstring)
        {
            DataSet ds = new DataSet();
