...
namespace EBid.lib.bid.trans
{
    public class IncotermTransaction
    {
        ...
        public DataTable GetIncoterm(string connstring)
        {
        ...
        public DataSet GetIncoterm_Buyer(string connstring)
        {
           return SqlHelper.ExecuteDataset(connstring, CommandType.StoredProcedure, "s3p_EBid_GetIncoterm1");
        }

        public string GetIncotermName(string connstring, string id)
        {
