...
namespace EBid.lib.bid.trans
{
    ...
    {
        public Product GetUOMAndDescriptionByProductId(string connstring, string vProductId)
        {
        ...
        public string GetUOMBySubCategoryId(string connstring, string vsubcateogryId)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
        ...
        public string GetUOMByProductId(string connstring, string vProductId)
        {
            if (vProductId != "")
            {
                try
        ...
        public DataTable SearchProduct(string connstring, string vSearch, string vBrandName, string vService, string vSubCategory)
        {
        ...
        public DataTable QueryProducts(string connstring, string vSearchString, string vSubCategoryId, string vCategoryId, string vMode)
        {
        ...
        public Product QueryProductBySKU(string connstring, string vSKU)
        {
        ...
        public DataTable GetProducts(string connstring, string vSubCategoryId, string vCategoryId)
        {
        ...
        public DataTable GetDescAndUOM(string connstring, string vSubCategoryId, string vCategoryId)
        {
        ...
        public DataTable QueryProductsViaName(string connstring, string queryString)
        {                                   
            SqlParameter[] sqlParams = new SqlParameter[1];
        ...
        public int InsertProduct(string connstring, string vSKU, string vItemName, string vProductDescription, string vUnitOfMeasure, string vCategory, string vSubCategory, string vBrand, string vServiceType  )
        {
        ...
        public int UpdateProduct(string connstring, string vSKU, string vItemName, string vProductDescription, string vUnitOfMeasure, string vCategory, string vSubCategory, string vBrand, string vServiceType)
        {
            SqlParameter[] sqlParams = new SqlParameter[8];
            sqlParams[0] = new SqlParameter("@SKU", SqlDbType.NVarChar);
            sqlParams[0].Value = vSKU;
        ...
        public Category InsertCategory(string connstring, string vCategoryId, string vCategoryName, string vCategoryDesc)
        {
            SqlParameter[] sqlParams = new SqlParameter[8];
        ...
        public int InsertSubCategory(string connstring, string vCategoryId, string vSubCategoryName, string vSubCategoryDesc)
        {
            SqlParameter[] sqlParams = new SqlParameter[8];
            sqlParams[0] = new SqlParameter("@CategoryId", SqlDbType.NVarChar);
            sqlParams[0].Value = vCategoryId;
        ...
        public int UpdateProductStatus(string connstring, string vSKU, int vStatus)
        {
