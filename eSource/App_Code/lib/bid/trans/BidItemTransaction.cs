...
namespace EBid.lib.bid.trans
{
    public class BidItemTransaction
    {
        ...
        public static BidItem GetBidDetailsByRefNo(string connstring, string bidRefNo)
        {
        ...
        public static ArrayList GetBidItemDetailsByRefNo(string connstring, int bidRefNo)
        {
        ...
        public static BidItem QueryBidInfo(string connstring, string BidRefNo)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@bidRefNo", SqlDbType.Int);
            sqlParams[0].Value = Int32.Parse(BidRefNo);
        ...
        public static void UpdateBidStatus(string connstring, string vBidRefNo, string vStatus)
        {
        ...
        public static int DeleteSupplierForABid(string connstring, string vBidRefNo)
        {
            SqlParameter[] sqlParams = new SqlParameter[2];
            sqlParams[0] = new SqlParameter("@BidRefNo", SqlDbType.Int);
            sqlParams[0].Value = Int32.Parse(vBidRefNo);
        ...
        public static BidItem QueryBidItemInfo(string connstring, string BidRefNo)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@bidRefNo", SqlDbType.Int);
            sqlParams[0].Value = Int32.Parse(BidRefNo);
        ...
        public static BidItem GetFileAttachment(string connstring, string vBidRefNo)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@bidRefNo", SqlDbType.Int);
            sqlParams[0].Value = Int32.Parse(vBidRefNo);
        ...
        public static DataTable GetVendorFileAttachments(string connstring, int vendorId, int bidRefNo)
        {
            SqlParameter[] sqlParams = new SqlParameter[2];
        ...
        public static void DeleteRemovedFileAttachment(string connstring, string files)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
        ...
        public static DataTable GetSuppliers(string connstring, string vBidRefNo)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@bidRefNo", SqlDbType.Int);
            sqlParams[0].Value = Int32.Parse(vBidRefNo);
        ...
        public static void UpdateFileAttachment(string connstring, string vBidRefNo, string newFileAttachments, string actualfilenames)
        {
        ...
        public static string InsertBidItem(
			string connstring, 
			string vPRRefNo,
            string vRequestor,
            string vItemDesc,
        ...
        public static bool InsertSuppliersForBid(string connstring, string vBidRefNo, string vSuppliers)
        {
            ...
            while (completed == false)
            {
                ...
                string retVal = InsertSuppliers(connstring, strSQL);
        ...
        private static string InsertSuppliers(string connstring, string strSQL)
        {
            SqlParameter[] sqlParams = new SqlParameter[2];
        ...
        public static string UpdateBidItem(
			string connstring, 
			string vPRRefNo,
            string vRequestor,
            string vItemDesc,
        ...
        public static string DeleteBidItem(string connstring, string vBidRefNo)
        {
        ...
        public static string QueryCountApproved(string connstring, string vBuyerId)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
        ...
        public static string QueryCountAllApproved(string connstring)
        {
        ...
        public static DataTable QueryBidsForEvaluationAndEndorsement(string connstring, string vBuyerId, string vForAuction, string vBidStatusApproved, string vBidTenderStatus, ref string vCount)
        {
        ...
        public static string QueryCountReedit(string connstring, string vBuyerId)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
        ...
        public static DataTable QueryBidsForReedit(string connstring, string vUserId, string orderby)
        {
        ...
        public static DataTable QueryAllBidsForReedit(string connstring, string orderby)
        {
            return SqlHelper.ExecuteDataset(connstring, CommandType.StoredProcedure, "s3p_EBid_QueryAllBidsForReedit").Tables[0];
        }

        public static DataTable QueryAllApprovedBids(string connstring, string orderby)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
        ...
        public static BidItem QueryFactsAboutABidItemByBidRefNo(string connstring, string BidRefNo)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@bidRefNo", SqlDbType.Int);
            sqlParams[0].Value = Int32.Parse(BidRefNo);
        ...
        public static DataTable GetBidItemsForConversion(string connstring, string strOrderBy)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@status", SqlDbType.Int);
        ...
        public static string GetBidName(string connstring, string vBidRefNo)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@bidRefNo", SqlDbType.Int);
            sqlParams[0].Value = Int32.Parse(vBidRefNo);
        ...
        public static int UpdateBidForAuctionStatus(string connstring, string vBidRefNo, int vStatus)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
        ...
        public static DataTable QueryAwardedBidTenders(string connstring, string vVendorId, string vOrderBy)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@vendorId", SqlDbType.Int);
        ...
        public static DataTable QuerySearchedItemByItemDesc(string connstring, int queryType, string queryString, int userType, int userId)
        {
        ...
        public static DataTable QueryDrafts(string connstring, string vBuyerId, string orderby)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
        ...
        public static DataTable QueryApprovedBids(string connstring, string vBuyerId, string orderby)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
            sqlParams[0] = new SqlParameter("@BID_STATUS_APPROVED", SqlDbType.Int);
            sqlParams[0].Value = Constant.BID_STATUS_APPROVED.ToString().Trim();
        ...
        public static DataTable QuerySubmittedBids(string connstring, string vBuyerId, string orderby)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
        ...
        public static DataTable QueryAllSubmittedBids(string connstring, string orderby)
        {
            SqlParameter[] sqlParams = new SqlParameter[2];
            sqlParams[0] = new SqlParameter("@BID_STATUS_SUBMITTED", SqlDbType.Int);
            sqlParams[0].Value = Constant.BID_STATUS_SUBMITTED.ToString().Trim();
        ...
        public static DataTable GetSuppliersByBidRefNo(string connstring, string vBidRefNo)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@BidRefNo", SqlDbType.Int);
            sqlParams[0].Value = vBidRefNo;
        ...
        public static DataTable QueryDeniedBidConversions(string connstring, string vBuyerId, string vOrderBy)
        {
            SqlParameter[] sqlParams = new SqlParameter[2];
        ...
        public static DataTable QueryRejectedBidItems(string connstring, string vBuyerId, string vOrderBy)
        {
            SqlParameter[] sqlParams = new SqlParameter[2];
        ...
        public static DataTable QueryBidEventsForConversion(string connstring, string vBuyerId, string vOrderBy)
        {
            SqlParameter[] sqlParams = new SqlParameter[2];
        ...
        public static DataTable QueryAwardedBidItems(string connstring, string vBuyerId, string vOrderBy)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
        ...
        public static DataTable QueryAwardedSuppliers(string connstring, string vBuyerId, string vBidRefNo, string vOrderBy)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
            sqlParams[0] = new SqlParameter("@BID_TENDER_STATUS_AWARD", SqlDbType.Int);
            sqlParams[0].Value = Constant.BID_TENDER_STATUS_AWARD.ToString().Trim();
        ...
        public static DataTable QueryReceivedTenders(string connstring, string vBuyerId)
        {
            SqlParameter[] sqlParams = new SqlParameter[4];
            sqlParams[0] = new SqlParameter("@BID_STATUS_APPROVED", SqlDbType.Int);
            sqlParams[0].Value = Constant.BID_STATUS_APPROVED.ToString().Trim();
        ...
        public static DataTable QueryRenegotiateBidItems(string connstring, string vBuyerId, string vOrderBy)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
        ...
        public static DataTable QueryRenegotiateBidItemsSent(string connstring, string vBuyerId)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
            sqlParams[0] = new SqlParameter("@BID_TENDER_STATUS_WAIT_FOR_RE_NEGOTIATE", SqlDbType.Int);
            sqlParams[0].Value = Constant.BID_TENDER_STATUS_WAIT_FOR_RE_NEGOTIATE.ToString().Trim();
        ...
        public static DataTable QueryEndorsedBidTendersItems(string connstring, string vBuyerId)
        {
            SqlParameter[] sqlParams = new SqlParameter[2];
        ...
        public static string QueryCountDrafts(string connstring, string vBuyerId)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
            sqlParams[0] = new SqlParameter("@BID_STATUS_DRAFT", SqlDbType.Int);
            sqlParams[0].Value = Constant.BID_STATUS_DRAFT.ToString().Trim();
        ...
        public static string QueryCountRejectedBidEvents(string connstring, string vBuyerId)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
            sqlParams[0] = new SqlParameter("@BID_STATUS_REJECTED", SqlDbType.Int);
            sqlParams[0].Value = Constant.BID_STATUS_REJECTED.ToString().Trim();
        ...
        public static int GetSubmittedBidsCount(string connstring, string vBuyerId)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
        ...
        public static string QueryCountBidEventsForConversion(string connstring, string vBuyerId)
        {
            SqlParameter[] sqlParams = new SqlParameter[2];
            sqlParams[0] = new SqlParameter("@BID_STATUS_REQUEST_TO_CONVERT", SqlDbType.Int);
            sqlParams[0].Value = Constant.BID_STATUS_REQUEST_TO_CONVERT.ToString().Trim();
        ...
        public static string QueryCountAwardedBidItems(string connstring, string vBuyerId)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
            sqlParams[0] = new SqlParameter("@BID_TENDER_STATUS_AWARD", SqlDbType.Int);
            sqlParams[0].Value = Constant.BID_TENDER_STATUS_AWARD.ToString().Trim();
        ...
        public static string QueryCountAwardedBidItems(string connstring, string vBuyerId, string vBidRefNo)
        {
            SqlParameter[] sqlParams = new SqlParameter[4];
            sqlParams[0] = new SqlParameter("@BID_TENDER_STATUS_AWARD", SqlDbType.Int);
            sqlParams[0].Value = Constant.BID_TENDER_STATUS_AWARD.ToString().Trim();
        ...
        public static string QueryCountForRenegotiateBidItems(string connstring, string vBuyerId)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
            sqlParams[0] = new SqlParameter("@BID_TENDER_STATUS_WAIT_FOR_RE_NEGOTIATE", SqlDbType.Int);
            sqlParams[0].Value = Constant.BID_TENDER_STATUS_WAIT_FOR_RE_NEGOTIATE.ToString().Trim();
        ...
        public static string QueryCountReceivedTenders(string connstring, string vBuyerId)
        {
            SqlParameter[] sqlParams = new SqlParameter[3];
        ...
        public static void UpdateBidStatusToEndorsed(string connstring, string vBidRefNo)
        {
        ...
        public static void ConvertBidToAuction(string connstring, string vBidRefNo, string vStatus)
        {
            SqlParameter[] sqlParams = new SqlParameter[2];
            sqlParams[0] = new SqlParameter("@Status", SqlDbType.Int);
            sqlParams[0].Value = vStatus;
        ...
        public static bool WithdrawBidItem(string connstring, int biddetailno, int status)
        {
            SqlConnection sqlConnect = new SqlConnection(connstring);
    ...
    public static class BidEventTransaction
    {
        ...
        #region Vendor
        private static bool ConfirmOrDeclineBidInvitation(string connstring, int bidrefno, int vendorid, ConfirmOrDecline todo)
        {
            bool success = false;
            try
            {
                ...
                int i = (int)SqlHelper.ExecuteScalar(connstring, "sp_ConfirmOrDeclineBidInvitation", sqlParams);
        ...
        public static bool ConfirmBidInvitation(string connstring, int bidrefno, int vendorid)
        {
            return ConfirmOrDeclineBidInvitation(connstring, bidrefno, vendorid, ConfirmOrDecline.Confirm);
        }

        public static bool DeclineBidInvitation(string connstring, int bidrefno, int vendorid)
        {
            return ConfirmOrDeclineBidInvitation(connstring, bidrefno, vendorid, ConfirmOrDecline.Decline);
        }
        #endregion

        public static int IsBidEventConfirmed(string connstring, int bidrefno, int vendorid)
        {
            int i = -1;
            try
            {
                ...
                DataSet ds = SqlHelper.ExecuteDataset(connstring, CommandType.StoredProcedure, "sp_IsBidEventConfirmed", sqlParams);
