...
namespace EBid.lib.bid.trans
{
	...
	{
        public ArrayList GetCategories(string connstring)
        {
		...
		public Category GetCategoryByID(string connstring, string id)
		{
        ...
        public string GetCategoryNameById(string connstring, string vCategoryId)
        {
            if (vCategoryId != "")
            {
                SqlParameter[] sqlParams = new SqlParameter[1];
        ...
        public DataTable GetAllCategories(string connstring)
        {
        ...
        public DataTable SearchCategory(string connstring, string vSearchText)
        {
        ...
        public DataTable GetAllSubCategories(string connstring)
        {
            DataSet dsQueryResult = new DataSet();
