...
namespace EBid.lib.auction.trans
{
	public class AuctionVendorTransaction
	{
		...
		public DataTable GetOngoingAuctions(string connstring, string vendorId, string orderBy)
		{
		...
		public DataTable GetAuctionItemDetailsByAuctionRefNo(string connstring, string auctionRefNo)
		{
		...
		public string[] GetAuctionParticipantsId(string connstring, string auctionRefNo)
		{
		...
		public ArrayList GetAuctionItemsDetail(string connstring, string auctionRefNo)
		{
            ...
            if (dataSet.Tables["tblAuctionItems"].Rows.Count > 0)
			{
				...
				{
					arrayList.Add(GetAuctionItemDetail(connstring, row["AuctionDetailNo"].ToString()));
				}
			}
        ...
        public DataTable QueryAuctionEventsByVendorID(string connstring, string vendorID, string orderby)
        {
        ...
        public DataTable QueryConfirmedAuctionByVendorID(string connstring, string vendorID)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
		...
		public string GetAuctionTenders(string connstring, int auctionDetailNo, int vendorId)
		{
            string bid = null;
		...
		public void InsertAuctionTender(string connstring, int auctionDetailNo, int vendorId, string tender)
		{
		...
		public void UpdateAuctionTender(string connstring, int auctionDetailNo, int vendorId, string tender)
		{
			string bids = GetAuctionTenders(connstring, auctionDetailNo, vendorId);

			if (bids == null)
			{
				InsertAuctionTender(connstring, auctionDetailNo, vendorId, tender);
			}
			else
			{
        ...
        public void UpdateAuctionInvitationStatus(string connstring, string vAuctionRefNo, string vUser, int vStatus)
        {
        ...
        public static string GetNewAuctionEventCountviaVendorId(string connstring, string vendorId)
        {
        ...
        public DataTable QueryAwardedVendorAuctionItem(string connstring, int vendorID, int status)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@vendorId", SqlDbType.Int);
        ...
        public DataTable QueryAuctionEventDates(string connstring, string vendorId)
        {
        ...
        public DataTable QueryVendorAuctionsViaDate(string connstring, string vendorId, string status, string date)
        {
            string query =  "SELECT t1.[AuctionRefNo], [ItemDesc], " +
                            "ISNULL(DATENAME(month, [AuctionDate]) + ' ' + CONVERT(varchar(2),(DATEPART(dd, [AuctionDate]))) + ', ' + CONVERT(varchar(4),(DATEPART(yyyy, [AuctionDate]))), '') as [AuctionDate1] " +
