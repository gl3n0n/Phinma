<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bidtendercomparisons.aspx.cs" Inherits="bidtendercomparisons" %>
                ...
                <td valign="top" align="center">
                    ...
                    <asp:SqlDataSource ID="sdsBidTenderComparisons" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>"
                        ...
                        <SelectParameters>
                            <asp:QueryStringParameter DefaultValue="0" Name="BidDetailNo" QueryStringField="bdn"
                                Type="Int32" />
                            <asp:ControlParameter ControlID="chkShowVendorName" DefaultValue="0" Name="UseAlias" Type="Int32" />
                            <asp:SessionParameter Name="ClientId" SessionField="ClientId" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>                    
                </td>
