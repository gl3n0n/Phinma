<%@ Page Language="C#" AutoEventWireup="true" CodeFile="approvedbiditems.aspx.cs" Inherits="web_buyer_screens_ApprovedBidItems" %>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="table4">
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:SqlDataSource ID="dsAproved" runat="server" ConnectionString='<%$ Code: (string) Session["ConnectionString"] ?? ConfigurationManager.ConnectionStrings["EbidConnectionString"].ConnectionString %>' SelectCommand="sp_GetBuyerApprovedBidEvents" SelectCommandType="StoredProcedure">
                                                        <SelectParameters>
