...
public partial class web_buyerscreens_bideventtenders : System.Web.UI.Page
{
    ...
    protected void fillGrid()
    {
        ...
        //myCommand.Parameters.AddWithValue("@BidRefNo", Convert.ToInt32(Session["BidRefNo"].ToString()));
    ...
    protected void lnkExportToExcel2_Click(object sender, EventArgs e)
    {
        ...
        //rvBidTendersForPOFileImport.Visible = true;
        //SqlConnection thisConnection = new SqlConnection(connstring);
        //System.Data.DataSet thisDataSet = new System.Data.DataSet();
        //SqlCommand sqlCom = new SqlCommand("sp_GetBidTendersForPOFileImport", thisConnection);
        //sqlCom.CommandType = CommandType.StoredProcedure;
        //sqlCom.Parameters.Add("@BidRefNo", SqlDbType.Int).Value = Convert.ToInt32(Session["BidRefNo"].ToString());
        //SqlDataAdapter dadapter = new SqlDataAdapter(); 
        //dadapter.SelectCommand = sqlCom;
        //dadapter.Fill(thisDataSet);


        //rvBidTendersForPOFileImport.Reset();
        //ReportDataSource datasource = new ReportDataSource("sp_GetBidTendersForPOFileImport", thisDataSet.Tables[0]);
        ////rvBidTendersForPOFileImport.LocalReport.ReportPath = Request.PhysicalApplicationPath + @"web\reports\bidtendersforpofileimport.rdlc";
        //rvBidTendersForPOFileImport.LocalReport.DataSources.Clear();
        //rvBidTendersForPOFileImport.LocalReport.DataSources.Add(datasource);
        //SqlDataAdapter.fill();
        //rvBidTendersForPOFileImport.DataBind();
        //rvBidTendersForPOFileImport.LocalReport.Refresh(); 
        //rvBidTendersForPOFileImport.Update(); 
        //rvBidTendersForPOFileImport.ShowReportBody = true;
        ...
        //rvBidTendersForPOFileImport.LocalReport.DataSources.Clear();
        //rvBidTendersForPOFileImport.LocalReport.DataSources.Add(source);
        //rvBidTendersForPOFileImport.DataBind();
        //rvBidTendersForPOFileImport.LocalReport.Refresh();
        //Response.Write(rvBidTendersForPOFileImport.LocalReport.DataSources.ToString());
        //rvBidTendersForPOFileImport.DataBind();
        //rvBidTendersForPOFileImport.LocalReport.Refresh();
        //int bidrefno = 0;
        //rvBidTendersForPOFileImport.LocalReport.ReportPath = Request.PhysicalApplicationPath + @"web\reports\bidtendersforpofileimport.rdlc";
        ...
        //rvBidTendersForPOFileImport.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("ReportDataSet_XX", ReportDataSet.Tables[int i]));
        //ReportParameter[] RequestorParameter2 = new ReportParameter[1];
        //RequestorParameter2[0] = new ReportParameter("BidRefNo", Session["BidRefNo"].ToString());
        //rvBidTendersForPOFileImport.LocalReport.SetParameters(RequestorParameter2);
        //rvBidTendersForPOFileImport.ShowReportBody = true;

        //string ACCPAC = "C:\\eSourcePOtoACCPAC\\";
        string ACCPAC = Constant.ACCPACUNPROC;
        //this.rvBidTendersForPOFileImport.RefreshReport();
