<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rejectedbiditems.aspx.cs"
    Inherits="WEB_buyer_screens_RejectedBidItems" %>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="table4">
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:SqlDataSource ID="dsRejected" runat="server" ConnectionString='<%$ Code: (string) Session["ConnectionString"] ?? ConfigurationManager.ConnectionStrings["EbidConnectionString"].ConnectionString %>'
