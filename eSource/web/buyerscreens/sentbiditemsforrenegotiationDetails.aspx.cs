...
public partial class WEB_buyer_screens_SentBidItemsForRenegotiationDetails : System.Web.UI.Page
{
    ...
    {
		Response.Redirect("sentbiditemsforrenegotiation.aspx");
    }
	...
	private DataTable CreateDataSource()
	{
		...
		DataTable dtDrafts = tenderTransaction.QuerySentRenegotiateBidTenderDetails(connstring, Session[Constant.SESSION_USERID].ToString(), Session[Constant.SESSION_BIDREFNO].ToString(), Session["ORDERBY"].ToString());
		return dtDrafts;
	}
