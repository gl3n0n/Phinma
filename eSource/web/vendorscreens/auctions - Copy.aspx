					    ...
					    DataSourceID="dsVendorAuctions" OnRowCommand="gvAuctionsForApproval_RowCommand" >
                                            <Columns>
                                                <asp:TemplateField HeaderText="Reference No." SortExpression="AuctionRefNo">
                                                    ...
                                                    <ItemTemplate>
                                                        &nbsp;<asp:LinkButton CommandName="Select" ID="lnkRefNo" runat="server" Text='<%# Eval("AuctionRefNo") %>'
                                                ...
                                                <asp:TemplateField HeaderText="Start Date" SortExpression="AuctionStartDateTime">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblStartDate" runat="server" Text='<%# Eval("AuctionStartDateTime", "{0:D}") %>'></asp:Label><br />
                                                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("AuctionStartDateTime", "{0:T}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="End Date" SortExpression="AuctionEndDateTime">
                                                    ...
                                                    <ItemStyle HorizontalAlign="Center" Width="140px" />
                                                    <ItemTemplate>                                                        
                                                        <asp:Label ID="lblEndDate" runat="server" Text='<%# Eval("AuctionEndDateTime", "{0:D}") %>'></asp:Label><br />
                                                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("AuctionEndDateTime", "{0:T}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Confirmation Deadline" SortExpression="AuctionDeadline">
													...
													<ItemTemplate>
													     <asp:Label ID="lblDeadline" runat="server" Text='<%# Eval("AuctionDeadline", "{0:D}") %>' Visible='<%# !ShowConfirmDeclineLink(Eval("ParticipationStatus").ToString(), Eval("AuctionDeadlineDiff").ToString()) %>' ></asp:Label>
