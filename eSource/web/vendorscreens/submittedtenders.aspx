<%@ Page Language="c#" Inherits="EBid.web.vendor_screens.SubmittedTenders" CodeFile="SubmittedTenders.aspx.cs" %>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td valign="top">
                                                ...
                                                <asp:SqlDataSource ID="dsSubmittedTenders" runat="server" ConnectionString='<%$ Code: (string) Session["ConnectionString"] ?? ConfigurationManager.ConnectionStrings["EbidConnectionString"].ConnectionString %>'
