...
public partial class web_vendorscreens_awardedauctiondetails : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        PageTitle.InnerText = String.Format(Constant.TITLEFORMAT, "Awarded Auction Item Details");

        if (Session[Constant.SESSION_AUCTIONDETAILNO] == null)
            Response.Redirect("awardedauctions.aspx");
    }
