...
{
	public partial class BidDetailsSubmitted : System.Web.UI.Page
	{	
    private string connstring = "";
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            PageTitle.InnerText = String.Format(Constant.TITLEFORMAT, "Submitted Bid Tender Details");
        ...
        {
            HiddenField hdnTenderStat = (HiddenField)TendersCommentArea.FindControl("hdnTenderStat");
            hdnTenderStat.Value = Constant.BID_TENDER_STATUS_SUBMITTED.ToString().Trim();
            HiddenField hdnBidRefNo = (HiddenField)TendersCommentArea.FindControl("hdnBidRefNo");
            hdnBidRefNo.Value = ViewState[Constant.SESSION_BIDREFNO].ToString().Trim();
            HiddenField hdnUserType = (HiddenField)TendersCommentArea.FindControl("hdnUserType");
            hdnUserType.Value = ViewState[Constant.SESSION_USERTYPE].ToString().Trim();
            HiddenField hdnUserID = (HiddenField)TendersCommentArea.FindControl("hdnUserID");
        ...
        protected void gvBids_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                Label lblITEM = (Label)e.Row.Cells[0].Controls[0];
                
                                
                if (lblITEM != null)
                {
                    if (lblITEM.Text == "Total Cost")
                    {
                    ...
                    if (lblITEM.Text == "Total Extended Cost")
                    {
                        lblITEM.ForeColor = Color.White;
                        //lblItemCost.ForeColor = Color.White;
                        e.Row.Cells[1].ForeColor = Color.White;
