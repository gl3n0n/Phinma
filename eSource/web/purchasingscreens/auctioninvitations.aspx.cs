...
public partial class web_purchasingscreens_auctioninvitations : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!(IsPostBack))
        {
            ...
            PageTitle.InnerText = String.Format(Constant.TITLEFORMAT, "Auction Event Invitations");
        }
    }
