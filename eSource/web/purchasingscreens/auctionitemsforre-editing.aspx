<%@ Page Language="C#" AutoEventWireup="true" CodeFile="auctionitemsforre-editing.aspx.cs" Inherits="web_purchasingscreens_auctionitemsforre_editing" %>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td id="content0">
                                                            ...
                                                            <asp:SqlDataSource ID="dsAuctionsForReedit" runat="server" ConnectionString='<%$ Code: (string) Session["ConnectionString"] ?? ConfigurationManager.ConnectionStrings["EbidConnectionString"].ConnectionString %>'
