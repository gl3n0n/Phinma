<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vsfviewOnly1.aspx.cs" Inherits="vsfviewOnly" EnableViewState="true" MaintainScrollPositionOnPostback="true"  %>
                                                        ...
                                                        <table width="25%" border="1" cellpadding="5" cellspacing="0" rules="all" class="itemDetails" style="border-color:#71A9D2; font-family: Arial; font-size: 11px; border-collapse: collapse; background-color: #F4F1C4; height:100%">
																<tbody>
																	...
																	<tr valign="middle">
																		...
																		<td align="center" valign="middle" bgcolor="#FFFFFF"><asp:Label ID="Accreditation" runat="server" Text='<%# Eval("Accreditation") %>' Font-Bold="True" Font-Size="10pt"></asp:Label></td>
