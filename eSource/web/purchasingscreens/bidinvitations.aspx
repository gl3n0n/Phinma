<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bidinvitations.aspx.cs" Inherits="web_purchasingscreens_bidinvitations" %>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td id="content0">
                                                            ...
                                                            <asp:SqlDataSource ID="sdsInvitations" runat="server" ConnectionString='<%$ Code: (string) Session["ConnectionString"] ?? ConfigurationManager.ConnectionStrings["EbidConnectionString"].ConnectionString %>' SelectCommand="sp_GetPurchasingBidInvitations" SelectCommandType="StoredProcedure">
                                                                <SelectParameters>
