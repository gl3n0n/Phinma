<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bids.aspx.cs" Inherits="EBid.WEB.purchasing_screens.bids" Theme="default" %>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td id="content0">
                                                            ...
                                                            <asp:SqlDataSource ID="dsSubmittedBids" runat="server" ConnectionString='<%$ Code: (string) Session["ConnectionString"] ?? ConfigurationManager.ConnectionStrings["EbidConnectionString"].ConnectionString %>'
