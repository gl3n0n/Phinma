<%@ Page Language="C#" AutoEventWireup="true" CodeFile="confirmedauctioninvitations.aspx.cs" Inherits="web_purchasing_screens_confirmedauctionInvitations" %>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td id="content0">
                                                            ...
                                                            <asp:SqlDataSource ID="dsConfirmedAuctions" runat="server" ConnectionString='<%$ Code: (string) Session["ConnectionString"] ?? ConfigurationManager.ConnectionStrings["EbidConnectionString"].ConnectionString %>'
