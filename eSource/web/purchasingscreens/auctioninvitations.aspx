<%@ Page Language="C#" AutoEventWireup="true" CodeFile="auctioninvitations.aspx.cs" Inherits="web_purchasingscreens_auctioninvitations" %>
                                                    ...
                                                    <tr>
                                                        <td id="content0">
                                                            ...
                                                            <p>
                                                                    ...
                                                                    <asp:SqlDataSource ID="sdsInvitations" runat="server" ConnectionString='<%$ Code: (string) Session["ConnectionString"] ?? ConfigurationManager.ConnectionStrings["EbidConnectionString"].ConnectionString %>' SelectCommand="sp_GetPurchasingAuctionInvitations" SelectCommandType="StoredProcedure">
                                                                        <SelectParameters>
