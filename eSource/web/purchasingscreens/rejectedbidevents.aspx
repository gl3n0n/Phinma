<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rejectedbidevents.aspx.cs" Inherits="web_purchasing_screens_RejectedBidEvents" Theme="default" %>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td id="content0">
                                                            ...
                                                            <asp:SqlDataSource ID="dsRejectedBidEvents" runat="server" ConnectionString='<%$ Code: (string) Session["ConnectionString"] ?? ConfigurationManager.ConnectionStrings["EbidConnectionString"].ConnectionString %>'
